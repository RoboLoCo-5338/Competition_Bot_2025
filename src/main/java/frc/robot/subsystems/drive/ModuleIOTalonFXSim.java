 ...
 */
public class ModuleIOTalonFXSim extends ModuleIOTalonFX implements SimMechanism{
    ...
    public double[] getCurrents() {
        return new double[] {
            Math.abs(simulation.getDriveMotorStatorCurrent().magnitude()), Math.abs(simulation.getSteerMotorStatorCurrent().magnitude())
        };
    }
}