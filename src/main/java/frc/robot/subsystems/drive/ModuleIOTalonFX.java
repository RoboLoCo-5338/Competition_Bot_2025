...
public abstract class ModuleIOTalonFX extends ModuleIO {
  ...
  protected ModuleIOTalonFX(
    ...
    turnConfig.Feedback.FeedbackSensorSource =
        switch (constants.FeedbackSource) {
          ...
          case TalonFXS_PulseWidth -> throw new UnsupportedOperationException(
              "Unimplemented case: " + constants.FeedbackSource);
    ...
    BaseStatusSignal.setUpdateFrequencyForAll(
        Drive.ODOMETRY_FREQUENCY, turnAbsolutePosition, drivePosition, turnPosition);
    BaseStatusSignal.setUpdateFrequencyForAll(
        50.0,
        driveVelocity,
        driveAppliedVolts,
