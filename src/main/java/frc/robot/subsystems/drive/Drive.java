...
public class Drive extends SubsystemBase implements Vision.VisionConsumer {
    ...
    public PIDController autoXDriveController = new PIDController(
            DriveConstants.AUTO_ALIGN_DRIVE_KP, DriveConstants.AUTO_ALIGN_DRIVE_KI, DriveConstants.AUTO_ALIGN_DRIVE_KD);
    public PIDController autoYDriveController = new PIDController(
            DriveConstants.AUTO_ALIGN_DRIVE_KP, DriveConstants.AUTO_ALIGN_DRIVE_KI, DriveConstants.AUTO_ALIGN_DRIVE_KD);
    public PIDController autoTurnController = new PIDController(
            DriveConstants.AUTO_ALIGN_DRIVE_KP, DriveConstants.AUTO_ALIGN_TURN_KI, DriveConstants.AUTO_ALIGN_DRIVE_KD);
